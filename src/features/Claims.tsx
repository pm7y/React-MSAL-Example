  ...
  return (
    <Page
      ...
      content={
        <>
          <p>
            Here are the claims present in the Id and Access tokens. They
            provided here for information and debugging purposes.
          </p>
          <UnauthenticatedTemplate>
          ...
          <AuthenticatedTemplate>
            <>
              ...
              <p>
                An ID token is used to authenticate a user. It provides
                information about the user, such as their identity and profile
                information.
              </p>
              {decodedIdToken && (
                <CodeBox
              ...
              <p>
                An access token is used to authorise access to protected
                resources or APIs. It tells the resource server what the client
